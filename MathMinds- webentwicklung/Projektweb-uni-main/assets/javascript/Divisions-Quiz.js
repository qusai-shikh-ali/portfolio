document.addEventListener("DOMContentLoaded", function() {
    ...
    function generateDivisionQuestion() {
        const num1 = Math.floor(Math.random() * 5) + 1; // Zahl zwischen 1 und 10
        const num2 = Math.floor(Math.random() * 5) + 1; // Zahl zwischen 1 und 10
    ...
    function checkDivisionAnswers() {
        ...
        setTimeout(displayDivisionQuestions, 4000);
    }
