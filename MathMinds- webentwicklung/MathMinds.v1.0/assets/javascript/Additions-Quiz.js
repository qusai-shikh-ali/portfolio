// Quiz mit mehreren Additionsaufgaben gleichzeitig

// Funktion zum Generieren einer zufälligen Additionsaufgabe
function generateQuestion() {
    const num1 = Math.floor(Math.random() * 10) + 1; // Zahl zwischen 1 und 20
    const num2 = Math.floor(Math.random() * 10) + 1; // Zahl zwischen 1 und 20
    return { num1, num2, answer: num1 + num2 };
}

// Funktion zum Anzeigen mehrerer Additionsaufgaben
