...
check1.addEventListener("click", () => {
   if(result1.value == "11/8" || result1.value == 1.375) {
...
check2.addEventListener("click", () => {
   if(result2.value == "2/15" || result2.value == 0.13) {
...
check3.addEventListener("click", () => {
   if(result3.value == "1/1" || result3.value == 1) {
...
check4.addEventListener("click", () => {
   if(result4.value == "5/2" || result4.value == 2.5) {
